...
typedef enum {
    QAPI_UART_5_BITS_PER_CHAR_E =
        0, /**< 5 bits per character. Due to hardware limitation, currently it is not support */
    QAPI_UART_6_BITS_PER_CHAR_E =
        1, /**< 6 bits per character. Due to hardware limitation, currently it is not support */
    QAPI_UART_7_BITS_PER_CHAR_E =
        2, /**< 7 bits per character. Due to hardware limitation, currently it is not support */
...
qapi_Status_t qapi_UART_Open(qapi_UART_Instance_t instance, qapi_UART_Open_Config_t *config);
...
qapi_Status_t qapi_UART_Receive(qapi_UART_Instance_t instance, char *buf, uint32_t buf_Size, uint32_t *recved);
...
qapi_Status_t qapi_UART_Transmit(qapi_UART_Instance_t instance, char *buf, uint32_t bytes_To_Tx, uint32_t *sent);
...
qapi_Status_t qapi_UART_Open_With_Rx_Timeout(qapi_UART_Instance_t instance, qapi_UART_Open_Config_t *config,
                                             uint32_t timeout);
