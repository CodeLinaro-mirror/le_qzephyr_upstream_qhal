...
void wifi_fw_program_pmic_and_aon_otp_trim(void)
{
    ...
    otp_tag_low = HWIO_INXF(SEQ_WCSS_OTP_OFFSET, FERMION_V1_0_QFPROM_RAW_FUSE_MAP_SECURITY_CONTROL_CORE_RAW_R_QFPROM_RAW_PTE_REGION_1_W3, TRIM_TAG_LOW);
    otp_tag_high = HWIO_INXF(SEQ_WCSS_OTP_OFFSET, FERMION_V1_0_QFPROM_RAW_FUSE_MAP_SECURITY_CONTROL_CORE_RAW_R_QFPROM_RAW_PTE_REGION_1_W3, TRIM_TAG_HIGH);
    ...
    {
        //MB
        uint32_t tOTP16=HWIO_INXF(SEQ_WCSS_OTP_OFFSET, FERMION_V1_0_QFPROM_RAW_FUSE_MAP_SECURITY_CONTROL_CORE_RAW_R_QFPROM_RAW_RF_CALIBRATION_ROW4_W2, LDO_1P6_VREF);
        ...
        tOTP16 = HWIO_INXF(SEQ_WCSS_OTP_OFFSET, FERMION_V1_0_QFPROM_RAW_FUSE_MAP_SECURITY_CONTROL_CORE_RAW_R_QFPROM_RAW_NPS_CONFIG_ROW1_W1, CORE_V2IC_TRIM);
        ...
        //AON trim
        tOTP16 = HWIO_INXF(SEQ_WCSS_OTP_OFFSET, FERMION_V1_0_QFPROM_RAW_FUSE_MAP_SECURITY_CONTROL_CORE_RAW_R_QFPROM_RAW_RF_CALIBRATION_ROW4_W3, LDO_RESERVD_0);
        HWIO_OUTXF(SEQ_WCSS_RPMU_OFFSET, RPMU_RPMU_R_PMU_CORE_5, LDO_AON_VSET_HIGH_OV_TRIM, 0x1);
        HWIO_OUTXF(SEQ_WCSS_RPMU_OFFSET, RPMU_RPMU_R_PMU_CORE_5, LDO_AON_VSET_HIGH, (tOTP16 & 0xff)); //bit 19:26 (19:31) //tOTP14

        //RC trim 27K from 32K
        tOTP16 = HWIO_INXF(SEQ_WCSS_OTP_OFFSET, FERMION_V1_0_QFPROM_RAW_FUSE_MAP_SECURITY_CONTROL_CORE_RAW_R_QFPROM_RAW_RF_CALIBRATION_ROW5_W0, LDO_RESERVD_1);
        HWIO_OUTXF(SEQ_WCSS_RPMU_OFFSET, RPMU_RPMU_R_PMU_CORE_2, CORE_RCOSC_32K_TRIM_SEL, 0x1);
        HWIO_OUTXF(SEQ_WCSS_RPMU_OFFSET, RPMU_RPMU_R_PMU_CORE_2, CORE_RCOSC_32K_TRIM, ((tOTP16 >> 9) & 0x1f)); //bit 9:13 (0:20)

        //CX trim only for OTPv3 and above
        if ((g_socpm_struct.cpr_cfg.ini_enabled == 1) && (otp_tag_high > OTP_TRIM_TAG_HIGH)) {
            tOTP16 = HWIO_INXF(SEQ_WCSS_OTP_OFFSET, FERMION_V1_0_QFPROM_RAW_FUSE_MAP_SECURITY_CONTROL_CORE_RAW_R_QFPROM_RAW_NPS_CONFIG_ROW1_W1, LDOCX_RDAC_CFG);
            HWIO_OUTXF(SEQ_WCSS_RPMU_OFFSET, RPMU_RPMU_R_PMU_CORE_12, LDOCX_VSET_TRIM_SEL, 0x1); //Auto Fetch //PMU Related
            HWIO_OUTXF(SEQ_WCSS_RPMU_OFFSET, RPMU_RPMU_R_PMU_CORE_12, LDOCX_VREF_TRIM, (tOTP16 & 0x1f)); //bit 23:27 (23:30)
        }
    }
#elif(FERMION_CHIP_VERSION == 2)
    //sync from HWS autoseq: void phyrf_otp_trim_pmu_iot()
    uint32_t otp_tag_high = HWIO_INXF(SEQ_WCSS_OTP_OFFSET, FERMION_V2_0_QFPROM_RAW_FUSE_MAP_SECURITY_CONTROL_CORE_RAW_R_QFPROM_RAW_PTE_REGION_1_W3, TRIM_TAG_HIGH);
    uint32_t otp_tag_low = HWIO_INXF(SEQ_WCSS_OTP_OFFSET, FERMION_V2_0_QFPROM_RAW_FUSE_MAP_SECURITY_CONTROL_CORE_RAW_R_QFPROM_RAW_PTE_REGION_1_W3, TRIM_TAG_LOW);
    uint32_t value;
    ...
    if (otp_tag_high >= 2)// for OTP >= v2
    {
        ...
        {
            // VIFERMION-435
            uint32_t	value_CORE_RCOSC_32K_TRIM = HWIO_INXF(SEQ_WCSS_OTP_OFFSET, FERMION_V2_0_QFPROM_RAW_FUSE_MAP_SECURITY_CONTROL_CORE_RAW_R_QFPROM_RAW_RF_CALIBRATION_ROW5_W0, CORE_RCOSC_32K_TRIM);  //bit 9:16
            uint32_t	value_XO_OSC_32K_TRIM_MSB = HWIO_INXF(SEQ_WCSS_RPMU_OFFSET, RPMU_RPMU_R_PMU_CORE_10, XO_OSC_32K_TRIM_MSB);  //bit 15:8
            value_XO_OSC_32K_TRIM_MSB &= 0xE3; // clear bit 12:10 of RPMU_RPMU_R_PMU_CORE_10
            value_XO_OSC_32K_TRIM_MSB |= ((value_CORE_RCOSC_32K_TRIM & 0x3) << 2);   // bit 11:10 of RPMU_RPMU_R_PMU_CORE_10 filled with bit 1:0 of value_CORE_RCOSC_32K_TRIM
            value_XO_OSC_32K_TRIM_MSB |= ((value_CORE_RCOSC_32K_TRIM & 0x80) >> 3); // bit 12 of RPMU_RPMU_R_PMU_CORE_10 filled with bit 7 of value_CORE_RCOSC_32K_TRIM
            HWIO_OUTXF(SEQ_WCSS_RPMU_OFFSET, RPMU_RPMU_R_PMU_CORE_10, XO_OSC_32K_TRIM_MSB, value_XO_OSC_32K_TRIM_MSB); // bit 12:10 of RPMU_RPMU_R_PMU_CORE_10 filled with bit 7, 1, 0 of value_CORE_RCOSC_32K_TRIM
            HWIO_OUTXF(SEQ_WCSS_RPMU_OFFSET, RPMU_RPMU_R_PMU_CORE_2, CORE_RCOSC_32K_TRIM, (value_CORE_RCOSC_32K_TRIM & 0x7c) >> 2); // bit 25:21 of RPMU_R_PMU_CORE_2 filled with bit 6:2 of value_CORE_RCOSC_32K_TRIM
            HWIO_OUTXF(SEQ_WCSS_RPMU_OFFSET, RPMU_RPMU_R_PMU_CORE_2, CORE_RCOSC_32K_TRIM_SEL, 0x1);
        }
        else
        {
            // 32K TRIM
            uint32_t	SleepClock = HWIO_INXF(SEQ_WCSS_OTP_OFFSET, FERMION_V2_0_QFPROM_RAW_FUSE_MAP_SECURITY_CONTROL_CORE_RAW_R_QFPROM_RAW_RF_CALIBRATION_ROW5_W0, CORE_RCOSC_32K_TRIM);  //bit 9:16
            HWIO_OUTXF(SEQ_WCSS_RPMU_OFFSET, RPMU_RPMU_R_PMU_CORE_2, CORE_RCOSC_32K_TRIM_SEL, 0x1);
        ...
        int32_t brown_out_thresh = HWIO_INXF(SEQ_WCSS_OTP_OFFSET, FERMION_V2_0_QFPROM_RAW_FUSE_MAP_SECURITY_CONTROL_CORE_RAW_R_QFPROM_RAW_RF_CALIBRATION_ROW8_W2, BROWN_OUT_THRES_TRIM);
        ...
        value = HWIO_INXF(SEQ_WCSS_OTP_OFFSET, FERMION_V2_0_QFPROM_RAW_FUSE_MAP_SECURITY_CONTROL_CORE_RAW_R_QFPROM_RAW_RF_CALIBRATION_ROW8_W1, LDO_AON_VSET_HIGH_VMX);
        HWIO_OUTXF(SEQ_WCSS_RPMU_OFFSET, RPMU_RPMU_R_PMU_CORE_5, LDO_AON_VSET_HIGH_OV_TRIM, 0x1);
        ...
        uint32_t    OTP_SMPS2_VREF_TRIM = HWIO_INXF(SEQ_WCSS_OTP_OFFSET, FERMION_V2_0_QFPROM_RAW_FUSE_MAP_SECURITY_CONTROL_CORE_RAW_R_QFPROM_RAW_NPS_CONFIG_ROW1_W0, SMPS2_VREF_TRIM);
    ...
    if ((otp_tag_high >= 2) && (otp_tag_high < 4))
    {
        ...
        uint32_t OTP_SMPS1_VREF_TRIM = HWIO_INXF(SEQ_WCSS_OTP_OFFSET, FERMION_V2_0_QFPROM_RAW_FUSE_MAP_SECURITY_CONTROL_CORE_RAW_R_QFPROM_RAW_NPS_CONFIG_ROW1_W0, SMPS1_VREF_TRIM);
	...
	if (otp_tag_high >= 3)// for OTP >= v3
    {
        ...
        uint32_t  ULPBG_VREF1 = HWIO_INXF(SEQ_WCSS_OTP_OFFSET, FERMION_V2_0_QFPROM_RAW_FUSE_MAP_SECURITY_CONTROL_CORE_RAW_R_QFPROM_RAW_RF_CALIBRATION_ROW5_W0, ULP_BG_LDOAO_VREF1_TRIM);
        uint32_t    ULPBG_VREF2 = HWIO_INXF(SEQ_WCSS_OTP_OFFSET, FERMION_V2_0_QFPROM_RAW_FUSE_MAP_SECURITY_CONTROL_CORE_RAW_R_QFPROM_RAW_RF_CALIBRATION_ROW4_W3, ULP_BG_LDOAO_VREF2_TRIM);
        ...
        uint32_t    OTP_SMPS1_ULP_COMP_VREF_TRIM = HWIO_INXF(SEQ_WCSS_OTP_OFFSET, FERMION_V2_0_QFPROM_RAW_FUSE_MAP_SECURITY_CONTROL_CORE_RAW_R_QFPROM_RAW_RF_CALIBRATION_ROW8_W2, SMPS1_ULP_COMP_VREF_TRIM);
        HWIO_OUTXF(SEQ_WCSS_RPMU_OFFSET, RPMU_RPMU_R_PMU_SMPS1_18, SMPS1_ULP_COMP_VREF_TRIM, OTP_SMPS1_ULP_COMP_VREF_TRIM);
    }
    ...
    {  
        if ((otp_tag_high == 4) && (otp_tag_low == 0))
        {
            ...
            HWIO_OUTXF(SEQ_WCSS_RPMU_OFFSET, RPMU_RPMU_R_PMU_SMPS2_18, SMPS2_ONESHOT_TRIM, 0x4);  //Default is 0x6, CS requires to set 4
        }
        else
        {
            uint32_t OTP_SMPS1_OS_TRM = HWIO_INXF(SEQ_WCSS_OTP_OFFSET, FERMION_V2_0_QFPROM_RAW_FUSE_MAP_SECURITY_CONTROL_CORE_RAW_R_QFPROM_RAW_RF_CALIBRATION_ROW9_W0, SMPS1_ONESHOT_TRIM);
            uint32_t OTP_SMPS2_OS_TRM = HWIO_INXF(SEQ_WCSS_OTP_OFFSET, FERMION_V2_0_QFPROM_RAW_FUSE_MAP_SECURITY_CONTROL_CORE_RAW_R_QFPROM_RAW_RF_CALIBRATION_ROW9_W0, SMPS2_ONESHOT_TRIM);
            ...
            NT_LOG_PRINT(HALPHY, INFO, "In OTPv4.1 or newer, program value %d/%d from OTP to SMPS1/2 oneshot trim", OTP_SMPS1_OS_TRM, OTP_SMPS2_OS_TRM);
        }
    }
    ...
    if (otp_tag_high >= 4)// for OTP >= v4
    {
        ...
        //SMPS1_VSET_HIGH
        uint32_t    OTP_SMPS1_VSET_HIGH = HWIO_INXF(SEQ_WCSS_OTP_OFFSET, FERMION_V2_0_QFPROM_RAW_FUSE_MAP_SECURITY_CONTROL_CORE_RAW_R_QFPROM_RAW_RF_CALIBRATION_ROW8_W3,SMPS1_VSET_HIGH);
        HWIO_OUTXF(SEQ_WCSS_RPMU_OFFSET, RPMU_RPMU_R_PMU_SMPS1_0, SMPS1_VSET_HIGH, OTP_SMPS1_VSET_HIGH);

        //SMPS2_ULP_COMP_VREF_TRIM
        uint32_t    OTP_SMPS2_ULP_COMP_VREF_TRIM = HWIO_INXF(SEQ_WCSS_OTP_OFFSET, FERMION_V2_0_QFPROM_RAW_FUSE_MAP_SECURITY_CONTROL_CORE_RAW_R_QFPROM_RAW_RF_CALIBRATION_ROW8_W2, SMPS2_ULP_COMP_VREF_TRIM);
        HWIO_OUTXF(SEQ_WCSS_RPMU_OFFSET, RPMU_RPMU_R_PMU_SMPS2_18, SMPS2_ULP_COMP_VREF_TRIM, OTP_SMPS2_ULP_COMP_VREF_TRIM);
...
void wifi_fw_pmic_init(cpr_mode_e cpr_mode)
{
    ...
    hal_mac_sw_powerup();
    g_ferm_neutrino_mode=NT_REG_RD(QWLAN_PMU_IO_RAW_STRAP_VALUE_REG)&QWLAN_PMU_IO_RAW_STRAP_VALUE_NEUTRINO_MODE_MASK?1:0;
    ...
    {
    	uint32_t TAG_HIGH = HWIO_INXF(SEQ_WCSS_OTP_OFFSET, FERMION_V2_0_QFPROM_RAW_FUSE_MAP_SECURITY_CONTROL_CORE_RAW_R_QFPROM_RAW_PTE_REGION_1_W3, TRIM_TAG_HIGH);
    	uint32_t TAG_LOW = HWIO_INXF(SEQ_WCSS_OTP_OFFSET, FERMION_V2_0_QFPROM_RAW_FUSE_MAP_SECURITY_CONTROL_CORE_RAW_R_QFPROM_RAW_PTE_REGION_1_W3, TRIM_TAG_LOW);
    ...
    //  HWIO_OUTXF(SEQ_WCSS_RPMU_OFFSET, RPMU_RPMU_R_BROWN_DET, VBAT_BROWN_EN, 1);
    HWIO_OUTXF(SEQ_WCSS_RPMU_OFFSET, RPMU_RPMU_R_PMU_ULPBG_6,
        ULP_BG_SELFSTART_DIS, 1);
    ...
    HWIO_OUTX3F(SEQ_WCSS_RPMU_OFFSET, RPMU_RPMU_R_PMU_ULPBG_7,
        ULP_BG_OTA_START_OV, ULP_BG_SELFSTART_DIS_OV, ULP_BG_START_EN_OV,
        0x2, 0x2, 0x2);
    ...
    if(g_ferm_neutrino_mode==1)
    {
        ...
        HWIO_OUTXF(SEQ_WCSS_RPMU_OFFSET,RPMU_RPMU_R_PMU_SMPS1_5,SMPS1_LPM_OVR,3);//follows TX enable signal from PHY 
        ...
        HWIO_OUTXF(SEQ_WCSS_RPMU_OFFSET,RPMU_RPMU_R_PMU_SMPS1_0,SMPS1_VREF_TRIM,17);//need to change per chip to be 0.87V
		...
		HWIO_OUTXF(SEQ_WCSS_RPMU_OFFSET,RPMU_RPMU_R_PMU_SMPS2_2,SMPS2_CL_SEL_PFM,0xf);//Default is 0xb (increase the value, increase the loading capability)
		HWIO_OUTXF(SEQ_WCSS_RPMU_OFFSET,RPMU_RPMU_R_PMU_SMPS2_4,SMPS2_CL_ILIM_MIN,0x7);//Default is 0xb (lower the value, increase current limit)
        ...
        HWIO_OUTXF(SEQ_WCSS_RPMU_OFFSET,RPMU_RPMU_R_PMU_SMPS2_3,SMPS2_VSET_SEL,cpr_mode);  // 0: open loop, 1: close loop
        if (cpr_mode == cpr_openloop) {
            HWIO_OUTXF(SEQ_WCSS_RPMU_OFFSET,RPMU_RPMU_R_PMU_SMPS2_0,SMPS2_VSET_HIGH,150);
        }
#ifdef HALMAC_UFW

        HWIO_OUTXF(SEQ_WCSS_RPMU_OFFSET,RPMU_RPMU_R_PMU_SMPS2_0,SMPS2_VSET_HIGH,101);//need to change per chip to be 0.55V
    ...
    HWIO_OUTXF(SEQ_WCSS_RPMU_OFFSET, RPMU_RPMU_R_BROWN_DET, VBAT_BROWN_SEL_ULP_BIAS, 1);
#endif
    HWIO_OUTXF(SEQ_WCSS_RPMU_OFFSET, RPMU_RPMU_R_PMU_CORE_12, LDOAO_VIN_MODE, 0x2);//use SMPS_S1 output always except Indefinite deepsleep
    //VIFERMION-190
    HWIO_OUTXF(SEQ_WCSS_RPMU_OFFSET, RPMU_RPMU_R_PMU_CORE_5,LDO_AON_INDEF_SLP_ONESHOT,0x3F);

#if (FERMION_CHIP_VERSION == 1)   
    uint32_t otp_tag_high = HWIO_INXF(SEQ_WCSS_OTP_OFFSET, FERMION_V1_0_QFPROM_RAW_FUSE_MAP_SECURITY_CONTROL_CORE_RAW_R_QFPROM_RAW_PTE_REGION_1_W3, TRIM_TAG_HIGH);
#else
    uint32_t otp_tag_high = HWIO_INXF(SEQ_WCSS_OTP_OFFSET, FERMION_V2_0_QFPROM_RAW_FUSE_MAP_SECURITY_CONTROL_CORE_RAW_R_QFPROM_RAW_PTE_REGION_1_W3, TRIM_TAG_HIGH);
