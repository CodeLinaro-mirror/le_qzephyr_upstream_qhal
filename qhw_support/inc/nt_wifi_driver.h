...
#define SLEEP_STATE_REG_CONFIGURATION_AON       0xFFFFFFCE //Mask for CFG_AON registers(wur sleep state and wifi sleep state registers)
...
#define SHIFT_REQUESTED_REQ                     0x6 //Shift the requested state 6 times to write it to the respective bit positions in the register
