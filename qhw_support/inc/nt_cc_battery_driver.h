...
#define QWLAN_TPE_INTERRUPT_STATUS_RINT_VBATT_TIMEOUT_INT_STATUS_OFFSET     0xF //Timeout interrupt enabling in TPE interrupt register
// #define QWLAN_TPE_SW_RINT_VBATT_RINT_VBATT_WINDOW_MON_EN_MASK		        0x100000 //Enable window monitoring for rint measurement
 ...
 *
 * @brief             : To measure the current battery level of coin cell battery. This function will do the configurations
                        for rint in respective registers and bit positions. ADC will start the sampling of data once the
