...
/*
 *   UHD               | NTC  |  MX    | NTC+5mV | NTC+10mV | NTC+15mV | NTC+20mV | NTC+25mV | NTC+30mV | NTC+35mV | NTC+40mV | NTC+45mV |Selection|
 * ------------------------------------------------------------------------------------------------------------------------------------------------
 * TT/CW corner voltage| 0.57 | 0.72SSG|                                        
 * -----------------------------------------------------------------------------------------  
 * mode                | NOM  |  NOM   |   
 * ------------------------------------------------------------------------------------------------------------------------------------------------
 * ro0_ro_aoi_40_lvt   | 244  |   633  |  258    |   272    |   286    |   300    |   314    |   328    |    342    |   356    |   370    |    X    |
 * ro1_ro_aoi_40_svt   | 104  |   398  |  113    |   122    |   131    |   139    |   148    |   157    |    166    |   175    |   184    |    X    |
 * ro2_ro_fa_40_ulvt   | 149  |   389  |  158    |   166    |   175    |   184    |   193    |   202    |    211    |   220    |   229    |         |
 * ro3_ro_fa_40_lvt    | 135  |   359  |  143    |   151    |   159    |   167    |   175    |   184    |    192    |   200    |   208    |         |
 * ro4_ro_ind_40_ulvt  | 396  |   916  |  417    |   437    |   458    |   478    |   499    |   519    |    540    |   560    |   581    |         |
 * ro5_ro_ind_40_lvt   | 403  |   868  |  421    |   440    |   458    |   476    |   495    |   513    |    531    |   549    |   568    |         |
 * ro6_ro_ind_40_svt   | 218  |   602  |  232    |   246    |   259    |   273    |   287    |   301    |    314    |   328    |   342    |         |
 * ro7_ro_ind_40_hvt   | 147  |   674  |  161    |   175    |   188    |   202    |   216    |   230    |    243    |   257    |   271    |    X    |
 * ro8_ro_mux4_40_ulvt |  92  |   222  |   96    |   101    |   106    |   111    |   116    |   121    |    126    |   131    |   136    |         |
 * ro9_ro_nd3_40_ulvt  | 271  |   652  |  286    |   301    |   316    |   332    |   347    |   362    |    377    |   392    |   407    |         |
 * ro10_ro_nd3_40_lvt  | 264  |   628  |  278    |   291    |   304    |   317    |   331    |   344    |    357    |   370    |   384    |         |
 * ro11_ro_nd3_40_svt  | 139  |   407  |  148    |   157    |   165    |   174    |   183    |   191    |    200    |   208    |   217    |         |
 * ro12_ro_nd3_40_hvt  |  97  |   466  |  106    |   116    |   125    |   134    |   143    |   152    |    161    |   170    |   179    |    X    |
 * ro13_ro_nr_40_hvt   |  70  |   461  |   95    |   103    |   111    |   120    |   128    |   136    |    144    |   153    |   161    |    X    |
 * ro14_ro_or_40_lvt   | 197  |   535  |  232    |   244    |   256    |   267    |   279    |   291    |    302    |   314    |   326    |    X    |
 * ro15_ro_or_40_svt   |  84  |   331  |  105    |   112    |   119    |   127    |   134    |   141    |    148    |   155    |   162    |    X    |
*/
