...
#define __msmhwio_outxm2(base, hwiosym, mask1, mask2, val1, val2) \
        out_dword(__msmhwio_addrx(base, hwiosym), ((__msmhwio_inx(base, hwiosym) & (uint32_t)(~(mask1 | mask2))) | (((uint32_t)((val1) & (mask1))) | ((uint32_t)((val2) & (mask2)))) ))

#define __msmhwio_outxm3(base, hwiosym, mask1, mask2, mask3,  val1, val2, val3) \
        out_dword(__msmhwio_addrx(base, hwiosym), ((__msmhwio_inx(base, hwiosym) & (uint32_t)(~(mask1 | mask2 | mask3))) | (((uint32_t)((val1) & (mask1))) | ((uint32_t)((val2) & (mask2))) | ((uint32_t)((val3) & (mask3)))) ))

#define __msmhwio_outxm4(base, hwiosym, mask1, mask2, mask3, mask4, val1, val2, val3, val4) \
        out_dword(__msmhwio_addrx(base, hwiosym), ((__msmhwio_inx(base, hwiosym) & (uint32_t)(~(mask1 | mask2 | mask3 | mask4))) | (((uint32_t)((val1) & (mask1))) | ((uint32_t)((val2) & (mask2))) | ((uint32_t)((val3) & (mask3))) | ((uint32_t)((val4) & (mask4)))) ))
