...
#if 0
__NVIC_EnableIRQ, ISER
__NVIC_DisableIRQ, ICER
__NVIC_GetPendingIRQ, ISPR
__NVIC_SetPendingIRQ, ISPR
__NVIC_ClearPendingIRQ, ICPR
...
#define NT_NVIC_ISER3	0xE000E10C	  //Irq 32 to 60 Set Enable Register
