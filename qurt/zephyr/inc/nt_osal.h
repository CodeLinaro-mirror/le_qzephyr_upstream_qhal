...
/*Delete the task*/
#define nt_osal_thread_delete(handler) qurt_thread_join(handler, 0)

/*Put a Message to a Queue*/

#define nt_osal_queue_send(queue_id, message, tick_to_wait) qurt_pipe_send_timed(queue_id, message, tick_to_wait)
...
#define nt_osal_delay(mil_sec) qurt_thread_sleep_ms(mil_sec)

#define qurt_sleep_ms qurt_thread_sleep_ms

/*Create and Initialize a Semaphore object*/
#define nt_osal_semaphore_create_binary(sem) qurt_sem_create(&sem)
