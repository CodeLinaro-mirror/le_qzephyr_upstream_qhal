...
*/
/* ======================================================================*/
int qurt_signal_wait_timed(qurt_signal_t *signal, unsigned int mask, unsigned int attribute, unsigned int *signals,
...
#else
#define qurt_signal_delete qurt_signal_destroy
#endif
