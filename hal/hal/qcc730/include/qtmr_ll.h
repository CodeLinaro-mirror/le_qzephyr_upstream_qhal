...
#ifdef QTMR_HAL
static inline void qtmr_hal_tmr_phy_ctr(qtmr_tmr_hal *hal, uint32_t value) { hal->QTMR_V1_CNTP_CTL.reg = value; }
...
static inline void qtmr_hal_ac_set_cnt_freq(qtmr_ac_hal *hal, uint32_t freq) { hal->QTMR_AC_CNTFRQ.reg = freq; }
