...
static inline void hal_qspi_set_pio_config(qspi_hal *hal, uint8_t write, uint8_t io_mode,
					   uint8_t fragment)
{
...
static inline void hal_qspi_set_pio_transfer_control_request_count(qspi_hal *hal,
...
static inline void hal_qspi_xip_region_config(qspi_hal *hal, uint32_t region_id,
					      uint32_t region_size, uint32_t regigon_addr)
{
