...
static inline void hal_qspi_clear_isr_status(qspi_hal *hal) { hal->QSPI_R_QSPI_MSTR_INT_STATUS.reg = 0xFFFFFFFF; }
...
static inline uint8_t hal_qspi_xip_is_enabled(qspi_hal *hal) { return hal->QSPI_R_QSPI_XIP_MASTER_CFG.bit.XIP_ENABLE; }
...
static inline uint32_t hal_qspi_xip_master_config_get(qspi_hal *hal) { return hal->QSPI_R_QSPI_XIP_MASTER_CFG.reg; }
